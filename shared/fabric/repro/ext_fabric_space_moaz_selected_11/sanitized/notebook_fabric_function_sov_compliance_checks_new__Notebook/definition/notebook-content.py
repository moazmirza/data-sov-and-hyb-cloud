...
# Function App + routes
# =========================
FUNCTION_BASE_URL = "https://<FUNCTION_APP>.azurewebsites.net"  # <-- set once
...
RESOURCE_APP_CLIENT_ID = "<RESOURCE_APP_CLIENT_ID>"  # the App ID URI audience used by EasyAuth
...
OWNER_EMAIL_DEMO_FALLBACK = "<OWNER_EMAIL>"   # <-- change if needed
