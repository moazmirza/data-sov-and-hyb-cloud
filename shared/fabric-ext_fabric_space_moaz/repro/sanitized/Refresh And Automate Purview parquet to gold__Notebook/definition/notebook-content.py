...
# META   "dependencies": {
# META     "lakehouse": {
# META       "default_lakehouse": "<FABRIC_ITEM_ID_3>",
# META       "default_lakehouse_name": "ext_lakehouse_fabric_moaz",
# META       "default_lakehouse_workspace_id": "<FABRIC_WORKSPACE_ID>",
# META       "known_lakehouses": [
# META         {
# META           "id": "<FABRIC_ITEM_ID_3>"
# META         }
# META       ]
# META     },
# META     "environment": {
# META       "environmentId": "<FABRIC_ENVIRONMENT_ID>",
# META       "workspaceId": "<FABRIC_WORKSPACE_ID>"
# META     }
# META   }
# META }
...
#   FROM glossaryterm
#   WHERE ParentGlossaryTermId = '<PURVIEW_GLOSSARY_PARENT_ID>'   -- Gl-Region parent
# ),
...
WITH RegionTerms AS (
  ...
  WHERE ParentGlossaryTermId = '<PURVIEW_GLOSSARY_PARENT_ID>'
),
ActiveRegionAssignments AS (
  SELECT
    DataProductId,
...
kv_purview_sap_url = "https://<KEYVAULT_NAME>.vault.azure.net/"
