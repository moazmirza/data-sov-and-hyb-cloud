...
| Solution 5: CC-for-PII Compliance via Agent | `module-05-cc-pii-compliance-via-agent` | End-to-end lineage of the Copilot topic and Power Automate flows that identify one eligible CC/PII resource and apply the investigation tag | Drafted |
